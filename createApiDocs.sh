...
desc_datalink='datalink protocol over web socket to a [Ringserver](https://github.com/EarthScope/ringserver) datalink server'
...
desc_irisfedcatalog='query EarthScope fedcatalog web service'
...
desc_nws='query US Nation Weather Service for forecast'
...
desc_organizeddisplayitem='subelements of OrganizedDisplay'
desc_organizeddisplayselect='select items to display in OrganizedDisplay'
desc_organizeddisplaytools='user tool widget for OrganizedDisplay'
...
desc_ringserverweb='presentation of data pulled from the web interface of a [Ringserver](https://github.com/EarthScope/ringserver)'
desc_ringserverweb4='presentation of data pulled from the web interface of a version 4 [Ringserver](https://github.com/EarthScope/ringserver)'
...
desc_seedlink='seedlink protocol over web socket to a [Ringserver](https://github.com/EarthScope/ringserver) seedlink server'
desc_seedlink4='seedlink version 4 protocol over web socket to a [Ringserver](https://github.com/EarthScope/ringserver) seedlink server'
...
desc_syngine='query EarthScope [Syngine](https://service.earthscope.org/irisws/syngine/docs/1/) web service for synthetic seismograms'
desc_taper='tapering of timeseries'
desc_taup3='travel times of seismic waves via TauP version 3 web service'
desc_textformat='number formatting'
desc_transition='animation transition helper'
desc_transfer='instrument deconvolution of seismograms using response'
desc_traveltime='travel times of seismic waves via the EarthScope traveltime web service'
